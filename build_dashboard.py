...
<style>
 :root{{--bg:#0f1115;--panel:#161922;--border:#262b36;--muted:#9aa0ab;--accent:#2d5cff}}
 *{{box-sizing:border-box}}
 body{{font:15px/1.6 -apple-system,Segoe UI,Roboto,sans-serif;margin:0;background:var(--bg);color:#e6e6e6}}
 header{{padding:40px 24px 28px;background:linear-gradient(180deg,#1a1f2b,#12151c);border-bottom:1px solid var(--border)}}
 ...
 .card h2 a{{color:#eaf0ff;text-decoration:none}} .card h2 a:hover{{color:#9ec1ff}}
 .summary{{margin:0 0 12px;color:#c7ccd6;font-size:13.5px;flex:1}}
 .tags{{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:12px}}
 .tag{{font-size:11px;color:#aeb6c4;background:#1d2230;border:1px solid var(--border);border-radius:10px;padding:2px 8px}}
 .cardfoot{{border-top:1px solid var(--border);padding-top:10px}}
 .open{{color:#9ec1ff;text-decoration:none;font-size:13px;font-weight:600}} .open:hover{{text-decoration:underline}}
 .open.disabled{{color:#5a6072;font-weight:400}}
 footer{{text-align:center;color:#5a6072;font-size:12px;padding:24px}}
 footer a{{color:#7a8294}}
</style></head><body>
